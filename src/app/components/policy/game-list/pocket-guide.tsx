...
export const PolicyPocketGuide = memo(
  forwardRef<Ref, Props>(() => {
    return (
      <div className={"policy-wrap"}>
        <strong>Privacy Policy</strong>{" "}
        <p>
          TheBeatLog built the Pocket Guide Portal app as a Free app. This
          SERVICE is provided by TheBeatLog at no cost and is intended for use
          as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Pocket Guide Portal
        ...
        <p>This policy is effective as of 2021-10-09</p>{" "}
        <p>

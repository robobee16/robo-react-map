...
export const PolicyDoraemon = memo(
  forwardRef<Ref, Props>(() => {
    return (
      <div className={"policy-wrap"}>
        <strong>Privacy Policy</strong>
        <p>
          The Bets built the Pocket Guide - Story of Seasons app as a Commercial
          app. This SERVICE is provided by The Bets and is intended for use as
          is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Pocket Guide - Story of
          Seasons unless otherwise defined in this Privacy Policy.
        </p>
        <p>
        ...
        <p>This policy is effective as of 2020-08-09</p>
        <p>
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at thebetlogs@gmail.com.
        </p>
        <p>

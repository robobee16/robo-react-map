...
export const PolicyFoMT = memo(
  forwardRef<Ref, Props>(() => {
    return (
      <div className={"policy-wrap"}>
        <strong>Privacy Policy</strong>
        <p>
          The Betlogs built the FoMT Story of Seasons Guide app as a Commercial
          app. This SERVICE is provided by The Betlogs and is intended for use
          as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at FoMT Story of Seasons
          Guide unless otherwise defined in this Privacy Policy.
        </p>
        <p>
        ...
        <p>This policy is effective as of 2020-04-16</p>
        <p>

...
export const PolicyPoOT = memo(
  forwardRef<Ref, Props>(() => {
    return (
      <div className={"policy-wrap"}>
        <strong>Privacy Policy</strong>
        <p>
          TheBeatLogs built the Pocket Guide - The Story of Seasons PoOT app as
          a Commercial app. This SERVICE is provided by TheBeatLogs and is
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Pocket Guide - The Story
          of Seasons PoOT unless otherwise defined in this Privacy Policy.
        </p>
        <p>

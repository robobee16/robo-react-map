...
export const PolicyMh = memo(
  forwardRef<Ref, Props>(() => {
    return (
      <div className={"policy-wrap"}>
        <strong>Privacy Policy</strong>{" "}
        <p>
          TheBeatLogs built the Pocket Guide - MH app as a Free app. This
          SERVICE is provided by TheBeatLogs at no cost and is intended for use
          as is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Pocket Guide - MH unless

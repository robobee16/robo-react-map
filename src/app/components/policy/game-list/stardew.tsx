...
export const PolicyStardew = memo(
  forwardRef<Ref, Props>(() => {
    return (
      <div className={"policy-wrap"}>
        <strong>Privacy Policy</strong>{" "}
        <p>
          The Beat Logs built the Pocket Guide - Stardew Valley app as a
          Commercial app. This SERVICE is provided by The Beat Logs and is
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Pocket Guide - Stardew
          Valley unless otherwise defined in this Privacy Policy.
        </p>{" "}
        <p>
        ...
        <p>This policy is effective as of 2020-12-20</p>{" "}
        <p>
